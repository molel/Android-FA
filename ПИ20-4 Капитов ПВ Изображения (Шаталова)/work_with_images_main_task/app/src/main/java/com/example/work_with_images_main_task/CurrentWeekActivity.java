...
public class CurrentWeekActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (arrayListWeek == null) {
            arrayListWeek = new ArrayList();
        }
        arrayAdapter = new ArrayAdapter(this, android.R.layout.simple_list_item_1, arrayListWeek);
        listView.setAdapter(arrayAdapter);
        arrayAdapter.notifyDataSetChanged();

        editText = findViewById(R.id.etWeek);
    }

    @Override
    public void onClick(View view) {
        arrayListWeek.add(editText.getText().toString());
        arrayAdapter.notifyDataSetChanged();
